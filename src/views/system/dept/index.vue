<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" class="custom-form" style="margin-bottom: 20px">
      ...
      <el-form-item class="add-button" style="margin-top: -4px">
        ...
        <el-button size="mini" type="info" @click="toggleExpandAll">展开/折叠</el-button>
      </el-form-item>
    </el-form>
