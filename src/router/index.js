    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/business/cps/product/add.vue'),
      },
      {
        ...
        component: () =>
          import('@/views/business/cps/equipment/add.vue'),
      },
      {
        ...
        component: () =>
          import('@/views/business/cps/data-acquisition-monitoring/View.vue'),
      },
      {
        path: 'ruledesign/design',
        name: '规则列表',
        meta: {
          title: "规则编排",
          noCache: true
        ...
        component: () =>
          import('@/views/business/ruledesign/design.vue'),
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/business/warning/configuration/add.vue'),
      },
    ]
  }
]
