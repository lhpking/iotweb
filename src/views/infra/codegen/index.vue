<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="68px" class="custom-form" style="margin-bottom: 20px">
      <el-form-item prop="tableName" style="margin-top: -1px">
        <el-input v-model="queryParams.tableName" placeholder="请输入表名称" clearable
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item prop="tableComment" style="margin-top: -1px">
      ...
      <el-button size="mini" type="info" @click="openImportTable" class="import-button">导入</el-button>
    </el-form>
    ...
    <!-- 列表 -->
    <el-table v-loading="loading" :data="tableList" style="height: calc(100vh - 240px);overflow-y: auto;">
      ...
      <el-table-column label="操作" align="center" width="300px" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button type="text" size="small" icon="el-icon-setting" @click="handleEditTable(scope.row)" v-hasPermi="['infra:codegen:update']">编辑</el-button>
