<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" size="mini" ref="queryForm" v-show="showSearch" :inline="true" class="custom-form" style="margin-bottom: 20px">
      ...
      <el-form-item prop="code" style="margin-top: -1px">
...
<!--        <el-button size="mini" type="warning" @click="handleExport">导出</el-button>-->
    ...
    <el-table v-loading="loading" :data="roleList" style="height: calc(100vh - 240px);overflow-y: auto;">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="备注">
          <el-input v-model="form.remark" type="textarea" placeholder="请输入内容" rows="5" maxlength="500"></el-input>
        </el-form-item>
      </el-form>
