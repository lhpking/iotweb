<template>
  <div>
    <el-popover v-model="visible" placement="bottom" width="600" trigger="click">
      <!-- icon 展示 -->
      <el-badge slot="reference" :is-dot="unreadCount > 0" type="danger">
         <svg-icon icon-class="mail" @click="getList"/>
      </el-badge>

      <!-- 弹出列表 -->
      <div>
        <el-table v-loading="loading" height="calc(100vh - 340px)" :data="list">
          <el-table-column width="180" align="center" property="createTime" label="接收时间">
