<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="68px" class="custom-form" style="margin-bottom: 20px">
      <el-form-item prop="module" style="margin-top: -1px">
        <el-input v-model="queryParams.module" placeholder="请输入系统模块" clearable style="width: 240px;"
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item prop="userNickname" style="margin-top: -1px">
      ...
      <el-form-item prop="startTime" style="margin-top: -1px">
    ...
    <el-table v-loading="loading" :data="list" style="height: calc(100vh - 240px);overflow-y: auto;">
      ...
      <el-table-column label="操作模块" align="center" prop="type" />
      <el-table-column label="操作名" align="center" prop="subType" width="180" />
