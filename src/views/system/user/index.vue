    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="68px"
                 class="custom-form" style="margin-bottom: 20px">
          <el-form-item prop="username" style="margin-top: -1px">
            <el-input v-model="queryParams.username" placeholder="请输入用户名称" clearable style="width: 240px"
                      @keyup.enter.native="handleQuery"/>
          </el-form-item>
          <el-form-item prop="mobile" style="margin-top: -1px">
          ...
          <el-form-item prop="createTime" style="margin-top: -1px">
            <el-date-picker v-model="queryParams.createTime" style="width: 240px" value-format="yyyy-MM-dd HH:mm:ss"
                            type="daterange"
                            range-separator="-" start-placeholder="创建开始日期" end-placeholder="创建结束日期"
...
<!--            <el-button size="mini" type="primary" @click="handleImport">导入</el-button>
        ...
        <el-table @select="userSelect" v-loading="loading" :data="userList" style="height: calc(100vh - 240px);overflow-y: auto;">
          <el-table-column v-if="multiple" type="selection" prop='id' lable=''></el-table-column>
          ...
          <el-table-column v-if="type != 'selectUser'" label="操作" align="center" width="160"
          ...
          <el-table-column v-else-if="!multiple && type == 'selectUser'">
            <template slot-scope="scope">
              <el-button size="mini" type="text" icon="el-icon-setting" @click="singleUserSelect(scope.row)">选择
              </el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    singleUserSelect(row) {
      this.$emit('singleUserSelect', row)
    },
    userSelect(list) {
